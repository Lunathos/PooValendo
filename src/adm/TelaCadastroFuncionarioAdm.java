...
public class TelaCadastroFuncionarioAdm extends javax.swing.JInternalFrame {
   ...
   ArrayList<Funcionario> ArrayListFuncionario = new ArrayList<> ();
    ...
    private void initComponents() {
        ...
        salarioTxt.setText("Salário");

        salarioF.setFont(new java.awt.Font("Arial", 0, 12)); // NOI18N
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(salarioTxt, javax.swing.GroupLayout.PREFERRED_SIZE, 17, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btnSaveFuncActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveFuncActionPerformed
        ...
        Funcionario f = new Funcionario(nomeF.getText(),Double.parseDouble(salarioF.getText()),(String)cargoF.getSelectedItem(), nascF.getText(), 
                                        (String)sexoF.getSelectedItem(), cpfF.getText(),
