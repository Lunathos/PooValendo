...
import javax.swing.table.TableCellRenderer;
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Nome", "Salário", "Cargo", "Data de Nascimento", "Sexo", "RG", "CPF", "Telefone", "E-mail", "País", "Uf", "Cidade", "Bairro", "Cep", "Complemento"
            }
        ));
        //
    ...
    private void btnRefreshActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRefreshActionPerformed
        mostrar();
         ...
         public void mostrar(){
        Object matriz[][] = new Object[ArrayListFuncionario.size()][16];
        
        for(int i=0;i<ArrayListFuncionario.size();i++){
              matriz[i][0]= ArrayListFuncionario.get(i).getNome();
              matriz[i][1]= ArrayListFuncionario.get(i).getSalario();        
              matriz[i][2]= ArrayListFuncionario.get(i).getCargo();
              matriz[i][3]= ArrayListFuncionario.get(i).getData_nasc();
              matriz[i][5]= ArrayListFuncionario.get(i).getSexo();
              matriz[i][6]= ArrayListFuncionario.get(i).getCpf();
              matriz[i][7]= ArrayListFuncionario.get(i).getRg();
              matriz[i][8]= ArrayListFuncionario.get(i).getTelefone();
              matriz[i][9]= ArrayListFuncionario.get(i).getEmail();
              matriz[i][10]= ArrayListFuncionario.get(i).getPais();
              matriz[i][11]= ArrayListFuncionario.get(i).getUf();
              matriz[i][12]= ArrayListFuncionario.get(i).getCidade();
              matriz[i][13]= ArrayListFuncionario.get(i).getBairro();
              matriz[i][14]= ArrayListFuncionario.get(i).getCep();
              matriz[i][15]= ArrayListFuncionario.get(i).getComplemento();
        }
            jTable1.setModel(new javax.swing.table.DefaultTableModel(
            matriz,
            new String [] {
               "Cargo", "Salário", "Nome", "Data de Nascimento", "Sexo", "RG", "CPF", "Telefone", 
